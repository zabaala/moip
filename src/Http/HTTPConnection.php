...
class HTTPConnection extends AbstractHttp
{
     ...
     * 
     * @see \Zabaala\Moip\Http\HTTPRequest::addRequestHeader()
     */
     ...
     *
     * @see \Zabaala\Moip\Http\HTTPConnection::clearHeaders()
     * @see \Zabaala\Moip\Http\HTTPConnection::clearParameters()
     */
     ...
     *
     * @return \Zabaala\Moip\Http\CookieManager
     */
     ...
     *
     * @param \Zabaala\Moip\Http\HTTPAuthenticator $httpAuthenticator
     */
     ...
     *
     * @param \Zabaala\Moip\Http\CookieManager $cookieManager
     */
