...
class CURL extends AbstractHTTPRequest
{
    ...
    /**
     * @var \Zabaala\Moip\Http\HTTPConnection
     */
     ...
     * Fecha a requisição.
     * 
     * @see \Zabaala\Moip\Http\HTTPRequest::close()
     */
     ...
     * 
     * @see \Zabaala\Moip\Http\HTTPRequest::execute()
     */
     ...
     * Abre a requisição.
     *
     * @param \Zabaala\Moip\Http\HTTPConnection $httpConnection Conexão HTTP relacionada com essa requisição
     * 
     * @see \Zabaala\Moip\Http\HTTPRequest::open()
     */
