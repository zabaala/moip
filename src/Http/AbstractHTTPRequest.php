...
abstract class AbstractHTTPRequest extends AbstractHttp implements HTTPRequest
{
     ...
     *
     * @param \Zabaala\Moip\Http\HTTPAuthenticator $authenticator
     *
     * @see \Zabaala\Moip\Http\HTTPRequest::authenticate()
     */
     ...
     *
     * 
     * @see \Zabaala\Moip\Http\HTTPRequest::getResponse()
     */
     ...
     * @throws \InvalidArgumentException Se o nome ou o valor do campo não forem valores scalar.
     *
     * @see \Zabaala\Moip\Http\HTTPRequest::setParameter()
     */
